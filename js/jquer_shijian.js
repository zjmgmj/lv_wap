    		...
    		var sjObj=o;
		        ...
		        sjObj.defaults={
		            ...
		            strStart:function(text,c){
		                ...
		                console.log(this);
		                if(df.width){
		                    str='<div class="df-item " style="height:'+(df.height*5-1)+'px;min-width:'+df.width+'px"><ul class="df-ul" data-class='+c+'>';
		                }else{
		                    str='<div class="df-item " style="height:'+(df.height*5-1)+'px"><ul class="df-ul" data-class='+c+'>';
		                }
		                sjObj.opt.dataNum++;
		                return str;
		            },
